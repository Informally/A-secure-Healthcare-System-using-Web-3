...
const contractABI = [
	...
	{
		"inputs": [],
		"name": "get_pending_nurse_approvals",
		"outputs": [
			{
				"internalType": "address[]",
				"name": "",
...
const contractAddress = '0xA9AFAA21aA72CCC3791e9BB164a7A11f86efE628'; // Your contract address
